...
Beyond all of the above, if you use these data or the scripts that generate them you are encouraged, but not required, to credit [EDJNet](https://europeandatajournalism.eu/) and, if relevant, to link to this repository.
