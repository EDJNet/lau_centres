...
lau_nuts_by_geo_file <- fs::path("lau_nuts_concordance_by_geo", 
                                     stringr::str_c(c("lau",
                                             lau_year,
                                             "nuts",
                                             nuts_year,
...
if (fs::file_exists(lau_nuts_by_geo_file)) {
  lau_nuts_by_geo_df <- readr::read_csv(file = lau_nuts_by_geo_file)
...
eu_file <- fs::path("lau_nuts_concordance_combo", 
...
if (fs::file_exists(eu_file)==FALSE) {
  readr::write_csv(x = lau_nuts_combo_df,
                   file = eu_file)
}
